<?php
  ...
  if(date("Y-m-d")==$newTo){
    ...
    $ovbxHoy = busquedaHoy('ovbx_mult_web_servicing',$newToF,$newTo, 'Throughput');
  }
  else {
    $ovbxHoy = busqueda('ovbx_mult_web_servicing',$newTo, 'Throughput');
  }
  $ovbxPasada = busqueda('ovbx_mult_web_servicing',$newFrom, 'Throughput');
  ...
  while($r3 = pg_fetch_assoc($ovbxHoy)) {
